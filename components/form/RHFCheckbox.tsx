            ...
            <div className="flex items-start space-x-3">
              <div className="relative flex items-center">
                ...
                <svg
                  className={`absolute w-3 h-3 pointer-events-none ${
                    disabled ? getThemeClasses("text-gray-400", "text-gray-600", currentTheme) : checkIconClass
              ...
              <div className="flex-1">
                {label && (
                  ...
                  >
                    {label}
                    {required && <span className={`${getThemeClasses("text-red-500", "text-red-400", currentTheme)} ml-1`}>*</span>}
                  </label>
                )}
                {helperText && !error && (
